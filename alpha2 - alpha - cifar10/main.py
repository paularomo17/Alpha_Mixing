...
def al_train_sub_experiment(args, train_args, train_params, strategy_name, general_path, seed):
    ...
    print('Round 0\nno_of_queries {}'.format(no_of_queries))
    print('Round 0\ntesting accuracy {}'.format(acc[0]))
    #print('Round 0\nduration {}'.format(duration))
    writer.add_scalar('no_of_queries', no_of_queries, 0)
    ...
    for rd in range(1, args.n_round + 1):
        ...
        no_of_queries += budget
        print('no_of_queries {}'.format(no_of_queries))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_name', type=str, default='CIFAR10', choices=['MNIST', 'EMNIST',
                                                          'SVHN', 'CIFAR10',
    ...
    parser.add_argument('--strategy', type=str, default='AlphaMixSampling',
